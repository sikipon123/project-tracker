...
class instructorModal extends Component {
    ...
    componentDidMount(){
        ...
        let projects = this.props.authAdmin.projects.filter(proj=>proj.idStudent === idStudent)
        this.setState({
            projects:projects
        })
            ...
            <div className="assign-modal">
                    <div className="modal-dialog " role="document">
                        ...
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel" style={{"color":"black"}}>Student Projects</h5>
